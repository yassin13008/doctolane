...
class __TwigTemplate_b9483edb7bfc8f7401043301be8f875b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"card container d-flex flex-column justify-content-around mt-2\" style=\"width: 30rem;\">
        ...
        <div class=\"card-body\">
            ...
            <a href=\" ";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show", ["id" => twig_get_attribute($this->env, $this->source, $context["professionnal"], "id", [], "any", false, false, false, 23)]), "html", null, true);
...
{% for professionnal in professionnals %}
    ...
    <div class=\"card container d-flex flex-column justify-content-around mt-2\" style=\"width: 30rem;\">
        ...
        <div class=\"card-body\">
            ...
            <a href=\" {{ path('show', {id : professionnal.id}) }}\" class=\"btn btn-primary\">En savoir plus </a>
