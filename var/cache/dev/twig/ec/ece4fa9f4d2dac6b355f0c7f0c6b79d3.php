...
class __TwigTemplate_ad3907719c7b7255e24e7d2279e42b7f extends Template
{
    private $source;
    private $macros = [];
...
<div>
    ...
    <h1>Résultats de la recherche</h1>
            ...
            <div class=\"card-body\">
                ...
                <a href=\" ";
                // line 35
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show", ["id" => twig_get_attribute($this->env, $this->source, $context["professional"], "id", [], "any", false, false, false, 35)]), "html", null, true);
    ...
    <h1>Résultats de la recherche</h1>
        ...
        <div class=\"card\">
            ...
            <div class=\"card-body\">
                ...
                <a href=\" {{ path('show', {id : professional.id}) }}\" class=\"btn btn-info\">En savoir plus </a>
            </div>
        </div>
            {% endfor %}
