...
class __TwigTemplate_d9762a0607475e51a3fdbb1ec60fb20a extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
    <button class=\"btn btn-outline-success col-4 mb-5\">";
        // line 5
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 5, $this->source); })()), "Enregistrement du rendez-vous")) : ("Enregistrement du rendez-vous")), "html", null, true);
        echo "</button>
";
        // line 6
...
";
    ...
    {
        return array (  57 => 6,  53 => 5,  49 => 4,  43 => 1,);
    }
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-outline-success col-4 mb-5\">{{ button_label|default('Enregistrement du rendez-vous') }}</button>
{{ form_end(form) }}
", "appointment/_form.html.twig", "C:\\laragon\\www\\cs-lane-stage\\Cs_Lane\\templates\\appointment\\_form.html.twig");
    }
}
