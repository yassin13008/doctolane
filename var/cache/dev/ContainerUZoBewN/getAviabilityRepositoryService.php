 ...
 */
class getAviabilityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AviabilityRepository' shared autowired service.
     *
     * @return \App\Repository\AviabilityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AviabilityRepository.php';

        return $container->privates['App\\Repository\\AviabilityRepository'] = new \App\Repository\AviabilityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
