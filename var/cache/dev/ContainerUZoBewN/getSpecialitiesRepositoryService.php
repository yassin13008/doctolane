 ...
 */
class getSpecialitiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SpecialitiesRepository' shared autowired service.
     *
     * @return \App\Repository\SpecialitiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SpecialitiesRepository.php';

        return $container->privates['App\\Repository\\SpecialitiesRepository'] = new \App\Repository\SpecialitiesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
