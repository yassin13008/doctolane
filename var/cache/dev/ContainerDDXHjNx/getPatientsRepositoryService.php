 ...
 */
class getPatientsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PatientsRepository' shared autowired service.
     *
     * @return \App\Repository\PatientsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PatientsRepository.php';

        return $container->privates['App\\Repository\\PatientsRepository'] = new \App\Repository\PatientsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
