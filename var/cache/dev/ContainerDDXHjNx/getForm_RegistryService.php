...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Form\\AviabilityType' => ['privates', 'App\\Form\\AviabilityType', 'getAviabilityTypeService', true],
            'App\\Form\\ContactType' => ['privates', 'App\\Form\\ContactType', 'getContactTypeService', true],
            'App\\Form\\EditPatientFormType' => ['privates', 'App\\Form\\EditPatientFormType', 'getEditPatientFormTypeService', true],
            'App\\Form\\EditProfessionnalFormType' => ['privates', 'App\\Form\\EditProfessionnalFormType', 'getEditProfessionnalFormTypeService', true],
            'App\\Form\\PatientsRegistrationFormType' => ['privates', 'App\\Form\\PatientsRegistrationFormType', 'getPatientsRegistrationFormTypeService', true],
            'App\\Form\\ProfessionnalsRegistrationFormType' => ['privates', 'App\\Form\\ProfessionnalsRegistrationFormType', 'getProfessionnalsRegistrationFormTypeService', true],
            'App\\Form\\ResetPassNewFormType' => ['privates', 'App\\Form\\ResetPassNewFormType', 'getResetPassNewFormTypeService', true],
            ...
            'App\\Form\\SearchProType' => ['privates', 'App\\Form\\SearchProType', 'getSearchProTypeService', true],
            ...
            'App\\Form\\AviabilityType' => '?',
            'App\\Form\\ContactType' => '?',
            'App\\Form\\EditPatientFormType' => '?',
            'App\\Form\\EditProfessionnalFormType' => '?',
            'App\\Form\\PatientsRegistrationFormType' => '?',
            'App\\Form\\ProfessionnalsRegistrationFormType' => '?',
            'App\\Form\\ResetPassNewFormType' => '?',
            'App\\Form\\ResetPasswordRequestFormType' => '?',
            'App\\Form\\SearchProType' => '?',
