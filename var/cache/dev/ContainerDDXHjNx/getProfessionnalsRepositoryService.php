 ...
 */
class getProfessionnalsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfessionnalsRepository' shared autowired service.
     *
     * @return \App\Repository\ProfessionnalsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfessionnalsRepository.php';

        return $container->privates['App\\Repository\\ProfessionnalsRepository'] = new \App\Repository\ProfessionnalsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
