 ...
 */
class DoctorsRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Doctors $entity, bool $flush = false): void
    {
    ...
    public function remove(Doctors $entity, bool $flush = false): void
    {
